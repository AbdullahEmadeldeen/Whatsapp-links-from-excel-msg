...
AR_TEMPLATE_FIXED = (
    ...
    "\nاوردر حضرتك متاح للتوصيل اليوم ان شاء الله من 4 الى 8م لو مناسب لحضرتك استاذنك اللوكيشن. "
    "\nاوردر حضرتك: \n{quantity}"
    "\nالاجمالي: {total}"
)
...
if file:
    ...
    for i, row in result_df.iterrows():
        ...
        z=1
        with st.expander(f"📞 {phone} | Order #{i+1}", expanded=(i < 3)):  # أول 3 طلبات مفتوحة افتراضيًا
            cols = st.columns([3, 1])
            with cols[0]:
